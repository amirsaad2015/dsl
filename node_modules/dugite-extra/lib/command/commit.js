...
function createCommit(repositoryPath, message) {
    return __awaiter(this, void 0, void 0, function () {
        var e_1, output, standardError, exitCode, error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, git_1.git(['commit', '-F', '-'], repositoryPath, 'createCommit', { stdin: message })];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
