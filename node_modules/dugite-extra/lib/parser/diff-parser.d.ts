...
export declare class DiffParser {
    ...
    private lineStartsWith(searchString);
    /** Tests if the current line ends with the given search text */
    private lineEndsWith(searchString);
    /**
     ...
     */
    private numberFromGroup(m, group, defaultValue?);
    /**
     ...
     */
    private parseHunk(linesConsumed);
    /**
