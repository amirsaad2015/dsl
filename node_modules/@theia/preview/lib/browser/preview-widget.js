...
var PreviewWidget = /** @class */ (function (_super) {
    ...
    function PreviewWidget(options, previewHandlerProvider, workspace, editorPreferences) {
        ...
        _this.internalRevealForSourceLine = throttle_debounce_1.throttle(50, function (sourceLine) {
    ...
    PreviewWidget.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.toDispose.push(theming_1.ThemeService.get().onThemeChange(function () { return _this.update(); }));
    ...
    PreviewWidget.prototype.startScrollSync = function () {
        var _this = this;
        this.node.addEventListener('scroll', throttle_debounce_1.throttle(50, function (event) {
    ...
    PreviewWidget.prototype.startDoubleClickListener = function () {
        var _this = this;
        this.node.addEventListener('dblclick', function (event) {
    ...
    PreviewWidget.prototype.onActivateRequest = function (msg) {
        ...
        if (this.node.children.length > 0) {
            this.node.children.item(0).focus();
        }
        else {
            this.node.focus();
        }
    ...
    PreviewWidget.prototype.fireDidDoubleClickToSourceLine = function (line) {
        ...
        this.onDidDoubleClickEmitter.fire({
            ...
            range: common_2.Range.create({ line: line, character: 0 }, { line: line, character: 0 })
        });
    };
    PreviewWidget.prototype.didDoubleClick = function (offsetTop) {
        ...
        var line = this.previewHandler.getSourceLineForOffset(this.node, offsetTop);
        if (line) {
    ...
    PreviewWidget = __decorate([
        ...
        __param(2, inversify_1.inject(common_2.Workspace)),
        __param(3, inversify_1.inject(browser_2.EditorPreferences)),
        __metadata("design:paramtypes", [Object, preview_handler_1.PreviewHandlerProvider, Object, Object])
    ], PreviewWidget);
