...
exports.default = new inversify_1.ContainerModule(function (bind) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, container.get(common_1.ResourceProvider)(new uri_1.default(uri))];
                        case 1:
                            resource = _a.sent();
    ...
    [common_1.CommandContribution, common_1.MenuContribution, browser_1.OpenHandler, browser_1.FrontendApplicationContribution].forEach(function (serviceIdentifier) {
