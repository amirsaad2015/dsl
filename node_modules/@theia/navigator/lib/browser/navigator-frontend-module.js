...
exports.default = new inversify_1.ContainerModule(function (bind) {
    ...
    bind(command_1.CommandContribution).toDynamicValue(function (c) { return c.container.get(navigator_contribution_1.FileNavigatorContribution); });
    bind(browser_1.KeybindingContribution).toDynamicValue(function (c) { return c.container.get(navigator_contribution_1.FileNavigatorContribution); });
    bind(common_1.MenuContribution).toDynamicValue(function (c) { return c.container.get(navigator_contribution_1.FileNavigatorContribution); });
