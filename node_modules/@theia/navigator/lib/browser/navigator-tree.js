...
var FileNavigatorTree = /** @class */ (function (_super) {
    ...
    function FileNavigatorTree(fileSystem, filter) {
        var _this = _super.call(this, fileSystem) || this;
        _this.fileSystem = fileSystem;
        _this.filter = filter;
        filter.onFilterChanged(function () { return _this.refresh(); });
        return _this;
    }
    ...
    FileNavigatorTree = __decorate([
        ...
        __param(1, inversify_1.inject(navigator_filter_1.FileNavigatorFilter)),
        __metadata("design:paramtypes", [Object, navigator_filter_1.FileNavigatorFilter])
    ], FileNavigatorTree);
