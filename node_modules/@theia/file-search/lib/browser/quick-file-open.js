...
var QuickFileOpenService = /** @class */ (function () {
    function QuickFileOpenService(fileSystem, workspaceService, openerService, quickOpenService, fileSearchService, labelProvider) {
        var _this = this;
    ...
    QuickFileOpenService.prototype.onType = function (lookFor, acceptor) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var token, proposed, rootUri, rootPath, handler;
            return __generator(this, function (_a) {
                ...
                proposed = new Set();
                rootUri = new uri_1.default(this.wsRoot.uri);
                rootPath = rootUri.path.toString();
                handler = function (result) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                if (!!token.isCancellationRequested) return [3 /*break*/, 2];
                                result.forEach(function (p) {
                                    var uri = rootUri.withPath(rootUri.path.join(p)).toString();
                                    proposed.add(uri);
                                });
                                itemPromises = Array.from(proposed).map(function (uri) { return _this.toItem(uri); });
                                _a = acceptor;
                                return [4 /*yield*/, Promise.all(itemPromises)];
                            case 1:
                ...
                this.fileSearchService.find(lookFor, { rootPath: rootPath, fuzzyMatch: true, limit: 200 }, token).then(handler);
                return [2 /*return*/];
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = FileQuickOpenItem.bind;
                        _b = [void 0, uri,
                            this.labelProvider.getName(uri)];
                        return [4 /*yield*/, this.labelProvider.getIcon(uri)];
                    case 1: return [2 /*return*/, new (_a.apply(FileQuickOpenItem, _b.concat([_c.sent(),
    ...
    QuickFileOpenService = __decorate([
        ...
        __param(3, inversify_1.inject(browser_1.QuickOpenService)),
        __param(4, inversify_1.inject(file_search_service_1.FileSearchService)),
        __param(5, inversify_1.inject(label_provider_1.LabelProvider)),
        __metadata("design:paramtypes", [Object, workspace_service_1.WorkspaceService, Object, browser_1.QuickOpenService, Object, label_provider_1.LabelProvider])
...
var FileQuickOpenItem = /** @class */ (function (_super) {
    ...
    function FileQuickOpenItem(uri, label, icon, parent, openerService) {
