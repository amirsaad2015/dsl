...
exports.default = new inversify_1.ContainerModule(function (bind) {
    ...
    try {
        for (var _a = __values([browser_1.FrontendApplicationContribution, browser_1.KeybindingContribution, common_1.CommandContribution, common_1.MenuContribution]), _b = _a.next(); !_b.done; _b = _a.next()) {
