...
var WidgetManager = /** @class */ (function () {
    ...
    WidgetManager.prototype.doGetWidget = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var existingWidgetPromise, existingWidget;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        existingWidgetPromise = this.widgetPromises.get(key);
                        if (!existingWidgetPromise) return [3 /*break*/, 2];
                        return [4 /*yield*/, existingWidgetPromise];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.doGetWidget(key)];
                    case 1:
                        existingWidget = _a.sent();
                        if (existingWidget) {
                            return [2 /*return*/, existingWidget];
