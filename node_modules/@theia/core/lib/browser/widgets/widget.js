                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            this.scrollBar = new perfect_scrollbar_1.default(container, {
                                suppressScrollX: true
                            });
                            this.toDispose.push(common_1.Disposable.create(function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    if (this.scrollBar) {
...
function addKeyListener(element, keybinding, action) {
    ...
    var keyCode = keys_1.KeyCode.createKeyCode({ first: keybinding });
