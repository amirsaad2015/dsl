...
var WidgetOpenHandler = /** @class */ (function () {
    ...
    WidgetOpenHandler.prototype.onActive = function (widget) {
        var _this = this;
        if (this.shell.activeWidget === widget) {
            return Promise.resolve();
        }
        return new Promise(function (resolve) {
            var listener = function (shell, args) {
                if (args.newValue === widget) {
                    _this.shell.activeChanged.disconnect(listener);
                    resolve();
                }
            };
            _this.shell.activeChanged.connect(listener);
        });
    };
    WidgetOpenHandler.prototype.onReveal = function (widget) {
        if (widget.isVisible) {
            return new Promise(function (resolve) { return window.requestAnimationFrame(function () { return resolve(); }); });
        }
        return new Promise(function (resolve) {
            var waitForVisible = function () { return window.requestAnimationFrame(function () {
                if (widget.isVisible) {
    ...
    WidgetOpenHandler.prototype.createWidgetOptions = function (uri, options) {
