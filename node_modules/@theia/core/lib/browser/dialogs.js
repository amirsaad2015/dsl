...
var AbstractDialog = /** @class */ (function (_super) {
    ...
    AbstractDialog.prototype.onAfterAttach = function (msg) {
        ...
        this.addKeyListener(document.body, keys_1.Key.ESCAPE, function () { return _this.close(); });
        this.addKeyListener(document.body, keys_1.Key.ENTER, function () { return _this.accept(); });
    };
