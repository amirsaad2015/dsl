...
var TabBarRenderer = /** @class */ (function (_super) {
    ...
    TabBarRenderer.prototype.createTabStyle = function (data) {
        ...
        if (labelSize || iconSize) {
            var labelHeight = labelSize ? labelSize.width : 0;
    ...
    TabBarRenderer.prototype.handleContextMenuEvent = function (event, title) {
...
var ScrollableTabBar = /** @class */ (function (_super) {
    ...
    function ScrollableTabBar(options) {
        ...
        _this.scrollBarFactory = function () { return new perfect_scrollbar_1.default(_this.node, options); };
        return _this;
    }
