...
import { TabBarRenderer, ScrollableTabBar } from './tab-bars';
...
export declare class DockPanelRenderer implements DockLayout.IRenderer {
    ...
    constructor(tabBarRendererFactory: () => TabBarRenderer);
...
export declare class ApplicationShell extends Widget {
    protected dockPanelRenderer: DockPanelRenderer;
     ...
     */
    constructor(dockPanelRenderer: DockPanelRenderer, statusBar: StatusBarImpl, sidePanelHandlerFactory: () => SidePanelHandler, splitPositionHandler: SplitPositionHandler, options?: RecursivePartial<ApplicationShell.Options>);
     ...
     */
    private onCurrentChanged(sender, args);
    /**
...
export declare namespace ApplicationShell {
     ...
     */
    function isSideArea(area?: Area): area is 'left' | 'right' | 'bottom';
    /**
     ...
     */
    interface WidgetOptions extends DockLayout.IAddOptions, SidePanel.WidgetOptions {
        /**
