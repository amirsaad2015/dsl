...
function bindViewContribution(bind, identifier) {
    ...
    bind(frontend_application_1.FrontendApplicationContribution).toService(identifier);
...
var AbstractViewContribution = /** @class */ (function () {
    ...
    AbstractViewContribution.prototype.openView = function (args) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var shell, widget, tabBar, area, widgetArgs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!tabBar) {
                            widgetArgs = __assign({}, this.options.defaultWidgetOptions, args);
    ...
    AbstractViewContribution.prototype.initializeLayout = function (app) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
