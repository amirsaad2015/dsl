...
describe('connection-status', function () {
    ...
    it('should go from online to offline if the connection is down', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    chai_1.expect(connectionStatusService.currentState.state).to.be.equal(connection_status_service_1.ConnectionState.INITIAL);
                    connectionStatusService.alive = false;
                    return [4 /*yield*/, pause()];
                case 1:
                    _a.sent();
                    chai_1.expect(connectionStatusService.currentState.state).to.be.equal(connection_status_service_1.ConnectionState.OFFLINE);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should go from offline to online if the connection is re-established', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    chai_1.expect(connectionStatusService.currentState.state).to.be.equal(connection_status_service_1.ConnectionState.ONLINE);
                    return [2 /*return*/];
            }
        });
    }); });
