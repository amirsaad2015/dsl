...
exports.default = new inversify_1.ContainerModule(function (bind) {
    ...
    bind(command_1.CommandContribution).toDynamicValue(function (c) { return c.container.get(outline_view_contribution_1.OutlineViewContribution); });
    bind(keybinding_1.KeybindingContribution).toDynamicValue(function (c) { return c.container.get(outline_view_contribution_1.OutlineViewContribution); });
    bind(menu_1.MenuContribution).toDynamicValue(function (c) { return c.container.get(outline_view_contribution_1.OutlineViewContribution); });
});
