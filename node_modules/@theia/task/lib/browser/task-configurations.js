...
var TaskConfigurations = /** @class */ (function () {
    function TaskConfigurations(logger, watcherServer, fileSystem) {
        ...
        this.toDispose = new _1.DisposableCollection();
        ...
        this.toDispose.push(_1.Disposable.create(function () {
    ...
    TaskConfigurations.prototype.refreshTasks = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tasksOptionsArray, tasksOptionsArray_1, tasksOptionsArray_1_1, task, e_1, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.readTasks(this.watchedConfigFileUri)];
                    case 1:
                        tasksOptionsArray = _b.sent();
                        if (tasksOptionsArray) {
                            ...
                            this.tasksMap.clear();
                            try {
                                for (tasksOptionsArray_1 = __values(tasksOptionsArray), tasksOptionsArray_1_1 = tasksOptionsArray_1.next(); !tasksOptionsArray_1_1.done; tasksOptionsArray_1_1 = tasksOptionsArray_1.next()) {
                                    task = tasksOptionsArray_1_1.value;
                                ...
                                try {
                                    if (tasksOptionsArray_1_1 && !tasksOptionsArray_1_1.done && (_a = tasksOptionsArray_1.return)) _a.call(tasksOptionsArray_1);
                                }
    ...
    TaskConfigurations.prototype.readTasks = function (uri) {
        return __awaiter(this, void 0, void 0, function () {
            var response, strippedContent, errors, tasks, errors_1, errors_1_1, e, err_2, e_2, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
