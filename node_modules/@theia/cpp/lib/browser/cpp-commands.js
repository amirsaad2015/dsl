...
function editorContainsCppFiles(editorManager) {
    if (editorManager && editorManager.activeEditor) {
        ...
        return common_3.HEADER_AND_SOURCE_FILE_EXTENSIONS.some(function (value) { return uri_2.endsWith("." + value); });
    }
    return false;
}
...
var CppCommandContribution = /** @class */ (function () {
    ...
    CppCommandContribution.prototype.switchSourceHeader = function () {
        ...
        this.clientContribution.languageClient.then(function (languageClient) {
            languageClient.sendRequest(cpp_protocol_1.SwitchSourceHeaderRequest.type, docIdentifier).then(function (sourceUri) {
    ...
    CppCommandContribution = __decorate([
        ...
        __metadata("design:paramtypes", [cpp_client_contribution_1.CppClientContribution, Object, browser_2.EditorManager,
