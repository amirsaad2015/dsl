...
exports.default = new inversify_1.ContainerModule(function (bind) {
    ...
    bind(browser_2.CallHierarchyService).toDynamicValue(function (ctx) { return ctx.container.get(typescript_callhierarchy_service_1.TypeScriptCallHierarchyService); }).inSingletonScope();
});
