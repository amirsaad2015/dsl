...
var TypeScriptCallHierarchyService = /** @class */ (function (_super) {
    ...
    TypeScriptCallHierarchyService.prototype.getEnclosingCallerSymbol = function (reference, context) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var symbols, bestMatch, bestRange, symbols_1, symbols_1_1, candidate, candidateRange, nameLocation, e_1, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, context.getAllSymbols(reference.uri)];
                    case 1:
                        symbols = (_b.sent()).filter(function (s) { return _this.isCallable(s); });
                        bestMatch = undefined;
                        bestRange = undefined;
                        try {
