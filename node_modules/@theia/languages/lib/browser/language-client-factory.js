...
var LanguageClientFactory = /** @class */ (function () {
    function LanguageClientFactory(workspace, languages, window, connectionProvider) {
    ...
    LanguageClientFactory.prototype.get = function (contribution, clientOptions) {
        var _this = this;
        var _a = this, workspace = _a.workspace, languages = _a.languages, window = _a.window;
        var commands = clientOptions.commands;
    ...
    LanguageClientFactory = __decorate([
        ...
        __param(2, inversify_1.inject(common_1.Window)),
        __param(3, inversify_1.inject(browser_1.WebSocketConnectionProvider)),
        __metadata("design:paramtypes", [Object, Object, Object, browser_1.WebSocketConnectionProvider])
