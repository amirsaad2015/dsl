...
var WorkspaceFrontendContribution = /** @class */ (function () {
    function WorkspaceFrontendContribution(fileSystem, fileDialogFactory, openerService, workspaceService, workspaceStorage, labelProvider) {
    ...
    WorkspaceFrontendContribution.prototype.showFileDialog = function () {
        ...
        this.workspaceService.root.then(function (resolvedRoot) { return __awaiter(_this, void 0, void 0, function () {
            var root, _a, rootUri, rootStat, name_1, label, rootNode, dialog, node;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.labelProvider.getIcon(root)];
                    case 4:
                        label = _b.sent();
                        rootNode = browser_2.DirNode.createRoot(rootStat, name_1, label);
                        dialog = this.fileDialogFactory({ title: workspace_commands_1.WorkspaceCommands.OPEN.label });
    ...
    WorkspaceFrontendContribution = __decorate([
        ...
        __param(5, inversify_1.inject(browser_1.LabelProvider)),
        __metadata("design:paramtypes", [Object, Function, Object, workspace_service_1.WorkspaceService, Object, browser_1.LabelProvider])
