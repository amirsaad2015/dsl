...
var GitHistoryContribution = /** @class */ (function (_super) {
    ...
    function GitHistoryContribution(selectionService) {
    ...
    GitHistoryContribution.prototype.registerMenus = function (menus) {
        menus.registerMenuAction(__spread(navigator_menu_1.NAVIGATOR_CONTEXT_MENU, ['5_history']), {
    ...
    GitHistoryContribution.prototype.showWidget = function (options) {
    ...
    GitHistoryContribution.prototype.newFileHandler = function (handler) {
    ...
    GitHistoryContribution = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.SelectionService])
