...
var CallHierarchyTreeModel = /** @class */ (function (_super) {
    ...
    function CallHierarchyTreeModel(tree, services, callHierarchyServiceProvider) {
        var _this = _super.call(this, tree, services) || this;
        _this.tree = tree;
        _this.callHierarchyServiceProvider = callHierarchyServiceProvider;
        return _this;
    }
    ...
    CallHierarchyTreeModel = __decorate([
        ...
        __param(0, inversify_1.inject(callhierarchy_tree_1.CallHierarchyTree)),
        __param(1, inversify_1.inject(browser_1.TreeServices)),
        __param(2, inversify_1.inject(callhierarchy_service_1.CallHierarchyServiceProvider)),
        __metadata("design:paramtypes", [callhierarchy_tree_1.CallHierarchyTree,
            browser_1.TreeServices,
            callhierarchy_service_1.CallHierarchyServiceProvider])
