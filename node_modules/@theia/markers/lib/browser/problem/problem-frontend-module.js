...
exports.default = new inversify_1.ContainerModule(function (bind) {
    ...
    try {
        for (var _a = __values([common_1.CommandContribution, common_1.MenuContribution, browser_1.KeybindingContribution, browser_1.FrontendApplicationContribution]), _b = _a.next(); !_b.done; _b = _a.next()) {
    ...
    bind(navigator_decorator_service_1.NavigatorTreeDecorator).to(problem_decorator_1.ProblemDecorator).inSingletonScope();
    var e_1, _c;
});
