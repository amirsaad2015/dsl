...
var UserStorageServiceFilesystemImpl = /** @class */ (function () {
    function UserStorageServiceFilesystemImpl(fileSystem, watcher, logger) {
        ...
        this.userStorageFolder = this.fileSystem.getCurrentUserHome().then(function (home) {
            var userStorageFolderUri = new uri_1.default(home.uri).resolve(THEIA_USER_STORAGE_FOLDER);
            ...
            return new uri_1.default(home.uri).resolve(THEIA_USER_STORAGE_FOLDER);
        });
    ...
    UserStorageServiceFilesystemImpl.prototype.onDidFilesChanged = function (fileChanges) {
        var _this = this;
        var uris = [];
        this.userStorageFolder.then(function (folder) {
            try {
                for (var fileChanges_1 = __values(fileChanges), fileChanges_1_1 = fileChanges_1.next(); !fileChanges_1_1.done; fileChanges_1_1 = fileChanges_1.next()) {
                    var change = fileChanges_1_1.value;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        exists = _a.sent();
                        if (exists) {
                            this.fileSystem.getFileStat(filesystemUri.toString()).then(function (fileStat) {
                                _this.fileSystem.setContent(fileStat, content).then(function () { return Promise.resolve(); });
                            });
                        }
                        else {
