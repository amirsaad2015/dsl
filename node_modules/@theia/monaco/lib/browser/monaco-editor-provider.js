...
var monaco_diff_nagivator_factory_1 = require("./monaco-diff-nagivator-factory");
...
function changeTheme(editorTheme) {
    var monacoTheme = editorTheme || 'vs-dark';
    monaco.editor.setTheme(monacoTheme);
    document.body.classList.add(monacoTheme);
}
changeTheme(theming_1.ThemeService.get().getCurrentTheme().editorTheme);
theming_1.ThemeService.get().onThemeChange(function (event) { return changeTheme(event.newTheme.editorTheme); });
var MonacoEditorProvider = /** @class */ (function () {
    function MonacoEditorProvider(editorService, textModelService, contextMenuService, m2p, p2m, workspace, commandServiceFactory, editorPreferences, quickOpenService, decorationsService, diffNavigatorFactory) {
    ...
    MonacoEditorProvider.prototype.get = function (uri) {
        return __awaiter(this, void 0, void 0, function () {
            var commandService, _a, editorService, textModelService, contextMenuService, override, toDispose, editor, standaloneCommandService;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = this, editorService = _a.editorService, textModelService = _a.textModelService, contextMenuService = _a.contextMenuService;
                        override = {
                        ...
                        return [4 /*yield*/, this.createEditor(uri, override, toDispose)];
                    case 2:
                        editor = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        editor = new monaco_editor_1.MonacoEditor(uri, model, document.createElement('div'), this.m2p, this.p2m, this.decorationsService, options, override);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        editor = new monaco_diff_editor_1.MonacoDiffEditor(uri, document.createElement('div'), originalModel, modifiedModel, this.m2p, this.p2m, this.decorationsService, this.diffNavigatorFactory, options, override);
    ...
    MonacoEditorProvider.prototype.getDiffNavigator = function (editor) {
        ...
        return monaco_diff_nagivator_factory_1.MonacoDiffNavigatorFactory.nullNavigator;
    };
    MonacoEditorProvider = __decorate([
        ...
        __param(9, inversify_1.inject(browser_1.EditorDecorationsService)),
        __param(10, inversify_1.inject(monaco_diff_nagivator_factory_1.MonacoDiffNavigatorFactory)),
        __metadata("design:paramtypes", [monaco_editor_service_1.MonacoEditorService,
            ...
            monaco_diff_nagivator_factory_1.MonacoDiffNavigatorFactory])
