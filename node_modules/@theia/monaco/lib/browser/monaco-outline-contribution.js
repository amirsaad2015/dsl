...
var MonacoOutlineContribution = /** @class */ (function () {
    ...
    MonacoOutlineContribution.prototype.onStart = function (app) {
        ...
        setTimeout(function () {
            _this.editorManager.onCurrentEditorChanged(function (widget) { return _this.updateOutlineForEditor(widget); });
        }, 3000);
    ...
    MonacoOutlineContribution.prototype.getModel = function (editor) {
        ...
        var model = monacoEditor.getControl().getModel();
    ...
    MonacoOutlineContribution.prototype.createTree = function (parentNode, symbolInformationList) {
        var _this = this;
        var isRangeBased = symbolInformationList.find(function (s) { return s.location.range.startLineNumber !== s.location.range.endLineNumber; }) !== undefined;
    ...
    MonacoOutlineContribution = __decorate([
        ...
        __metadata("design:paramtypes", [outline_view_service_1.OutlineViewService,
