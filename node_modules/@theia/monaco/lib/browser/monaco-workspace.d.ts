...
import { Event, TextDocument, TextDocumentWillSaveEvent } from "@theia/languages/lib/common";
...
export declare class MonacoWorkspace extends BaseMonacoWorkspace implements lang.Workspace {
    ...
    protected readonly onWillSaveTextDocumentEmitter: lang.Emitter<lang.TextDocumentWillSaveEvent>;
    protected readonly onDidSaveTextDocumentEmitter: lang.Emitter<lang.TextDocument>;
    ...
    protected groupEdits(workspaceEdit: monaco.languages.WorkspaceEdit): Map<string, monaco.languages.IResourceEdit[]>;
}
